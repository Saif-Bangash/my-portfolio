...
export default function About() {
  return (
    <section
      className="bg-gray-900 text-white py-33 px-6 md:px-16 lg:px-32"
      id="about"
    >
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-gray-400 mb-6">
            I'm a Frontend Developer with one year experience in building modern
            and responsive web applications. I specialize in React, Tailwind
            CSS, and creating intuitive UI/UX designs.
          </p>
          <p className="text-gray-400 mb-6">
